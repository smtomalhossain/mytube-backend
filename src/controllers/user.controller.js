...
// Changes the current password for the authenticated user
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    if (!fullName || !email) {
        throw new ApiError(400, "All Field rew requires")
    }
...
// Update the logged-in user's avatar image
...
// Update the logged-in user's cover image
